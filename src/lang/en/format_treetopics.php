...
$string['showhiddenactivities'] = 'Show hidden activities';
$string['hidehiddenactivities'] = 'Hide hidden activities';
$string['deletesection'] = 'Delete topic';
$string['newsectionname'] = 'New name for topic {$a}';
$string['sectionname'] = 'Topic';
$string['pluginname'] = 'Tree Topics format';
...
$string['subsections'] = 'Number of subsections';
$string['sectionparent'] = 'Parent';
$string['sectionshowactivities'] = 'Show activities';
...
$string['sectionparent_help'] = 'Help Parent';
$string['sectionshowactivities_help'] = 'Help Show activities';
$string['imagegridcolumns_help'] = 'Help Image Grid';
$string['sectionimage_help'] = 'Image ';
$string['sectionimagecontext_help'] = 'Image Context';
$string['sectionimagecomponent_help'] = 'Image Component';
