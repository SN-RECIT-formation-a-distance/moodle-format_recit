...
$string['pluginname'] = 'Format RÉCIT arborescence de sections ';
...
$string['displaytabslev1'] = 'Contenu de niveau 1';
$string['displaytabslev2'] = 'Contenu de niveau 2';
...
$string['sectiondisplay'] = 'Niveau de cette section';
$string['sectioncontentdisplay'] = 'Type de présentation de cette section';
$string['subsections'] = 'Numéro des sous-section';
$string['sectionparent'] = 'Parent';
$string['sectionshowactivities'] = 'Afficher les ressources et les activiés';
...
$string['sectionimageurl'] = 'Adresse de l\'image';
$string['sectionimageurl_help'] = 'Nous suggerons de déposer vos images dans les ficiers obsolètes et de taper l\'adresse de votre image ici';
...
$string['sectiondisplay_help'] = 'Ce format permet de présenter les sections de façon hierarchique.';
$string['sectioncontentdisplay_help'] = 'Ce réglage permet de selectionner l\affichage par image ou par onglet.';
$string['subsections_help'] = 'Aide Subsections';
$string['sectionparent_help'] = 'Aide Parent';
...
$string['imagegridcolumns_help'] = 'Choisir le nombre maximal de colonnes qui seront affichées en mode image.';
$string['sectionimage_help'] = 'Image ';
$string['sectionimagecontext_help'] = 'Contexte de l\'image';
$string['sectionimagecomponent_help'] = 'Composant de l\'image';
$string['sectionimagefilearea_help'] = 'Image Filearea';
$string['sectionimageitemid_help'] = 'ID de l\'item image';
$string['sectionimagefilepath_help'] = 'Image Filepath';
$string['sectionimagefilename_help'] = 'Nom du fichier image';
$string['sectionimagesummary'] = "Résumé de section en mode image";
$string['sectionimagesummary_help'] = "Le résumé de section en mode image est un texte assez bref destiné à préparer les étudiants aux activités présentées dans la section.";

$string['tabsmodel_help'] = 'Les onglets peuvent avoir un visuel différent. Vous pouvez choisir le modèle qui vous convient';
