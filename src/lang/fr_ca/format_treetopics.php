...
$string['pluginname'] = 'Format arborescence de sections ';
$string['section0name'] = 'General';
$string['page-course-view-topics'] = 'Toutes les pages pricipales de cours dans le format';
$string['page-course-view-topics-x'] = 'Touess les pages du cours dans le format';
$string['hidefromothers'] = 'Cacher la section';
$string['showfromothers'] = 'Montrer la section';
$string['privacy:metadata'] = 'Ce format de cours de conserve aucune donnée personnelle.';
...
$string['displayshortcuts'] = "Afficher les raccourcis lorsque le mode d'édition est activé";
...
$string['imagegridcolumns'] = 'Nombre de colonnes maximales';
...
$string['displayshortcuts_help'] = 'Aide affichage';
...
$string['sectionshowactivities_help'] = 'Aide Show activities';
$string['imagegridcolumns_help'] = 'Choisir le nombre de colonne maximal qui sera aiifhcé en mde image.';
...
$string['sectionimagesummary'] = "Sommaire image";
$string['sectionimagesummary_help'] = "Sommaire image";

$string['tabsmodel_help'] = 'Aide à prorpos du modèle d\'ongelt';
$string['imagewidth_help'] = "Width of the images in the grid in pixel. The height will be adjusted with the image's ratio";
$string['showsectiontitle_help'] = 'Aide concernant le titre de section';
...
$string['hascontract_help'] = 'Aide pou l\'utilisation du contrat d\'engagement';
$string['contract_help'] = 'Aide pour le contrac d\engagement';