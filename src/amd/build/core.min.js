...
define(['jquery'], function($) {
    return {
        init: function() {
            ...
            function onClickNav(event, datasection) {
                var datasection = datasection || $(event.target).attr('data-section');
                if (typeof datasection !== typeof undefined && datasection !== false) {
                    document.cookie = 'section=' + datasection;
                    let sectionID = '#' + datasection;
            ...
            $('#tt-recit-nav a').on('click', (event) => onClickNav(event));
            $('#tt-btn-start-course').on('click', (event) => onClickNav(event));
            ...
            $(window).ready(function() {
                ...
                let sectionID = anchors[1] || getCookie('section');
