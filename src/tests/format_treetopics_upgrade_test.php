...
require_once($CFG->dirroot . '/course/format/treetreetopics/db/upgradelib.php');

/**
 * format_treetopics unit tests for upgradelib
 *
 * @package    format_treetopics
 * @copyright  2017 Marina Glancy
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class format_treetopics_upgrade_testcase extends advanced_testcase {
    ...
    public function test_numsections_no_actions() {
        ...
        $params = array('format' => 'treetreetopics', 'numsections' => 5, 'startdate' => 1445644800);
        $course = $this->getDataGenerator()->create_course($params);
        // This test is executed after 'numsections' option was already removed, add it manually.
        $DB->insert_record('course_format_options', ['courseid' => $course->id, 'format' => 'treetopics',
        ...
        format_treetopics_upgrade_remove_numsections();
    ...
    public function test_numsections_delete_empty() {
        ...
        $params1 = array('format' => 'treetopics', 'numsections' => 5, 'startdate' => 1445644800);
        $course1 = $this->getDataGenerator()->create_course($params1);
        $params2 = array('format' => 'treetopics', 'numsections' => 20, 'startdate' => 1445644800);
        ...
        $DB->insert_record('course_format_options', ['courseid' => $course1->id, 'format' => 'treetopics',
    ...
    public function test_numsections_hide_non_empty() {
        ...
        $params = array('format' => 'treetopics', 'numsections' => 5, 'startdate' => 1445644800);
        $course = $this->getDataGenerator()->create_course($params);
    ...
    public function test_numsections_add_empty_sections() {
        ...
        $params = array('format' => 'treetopics', 'numsections' => 16, 'startdate' => 1445644800);
        $course = $this->getDataGenerator()->create_course($params);
